              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Are you sure you want to delete the user <span className="font-medium text-gray-700 dark:text-gray-300">{userName || 'Unknown'}</span>? This action cannot be undone.
                  </p>
                </div>
              </div>
            </div>
